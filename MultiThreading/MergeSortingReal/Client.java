...
public class Client {
    public static void main(String[] args) throws Exception {
        ...
        //To submit the code for callable we use .submit method for runnable it was .execute
        // Here as callable return something there might be a possiblity that parallel task need other task to complete
        // So we use Future object for it and run remaining code parallely and when we need the future task
