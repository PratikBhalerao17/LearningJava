...
CPU has core and each core can run 1 thread at a time
    ...
    2. Create a seperate class for our task --> HelloWorldPrinter.java
    3. Make this class implements the runnable interface
    4. Implement the run method of runnable interface
    5. Create a thread object from where we need to call the thread and pass the thread object to it
    6. Start the thread
         */

        //Create object of class
        HelloWorldPrinter printer=new HelloWorldPrinter();
        Thread t=new Thread(printer); //create a object of thread clas and pass object of our task
