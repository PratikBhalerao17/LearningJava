...
public class Client {
    public static void main(String[] args) {
       // Instead of creating 100 threads we can use executorService where we can reuse the threads once completed
        ...
        // threads manually .Executor will handle it for us. Task class won't change

        /*
Steps to use Executor:
1. create a task class for the task we need to perform in parallel make it implements Runnable interface and
override run() method of it.
