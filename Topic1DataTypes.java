...
/*
1. byte :	1 byte	Stores signed whole numbers from -128 to 127
*/
//        byte a= -128; //range 2^8 = 256 so range is -2^7 to 2^7-1
//        byte b[]=new byte[5];
//        System.out.println(b[0]); //returns 0 as default value of byte is 0
/*
2. short :	2 bytes	Stores signed whole numbers from -32,768 to 32,767
 */
//        short c = 32767; // range -2^15 to 2^15-1

//3. int	4 bytes	Stores signed whole numbers from -2,147,483,648 to 2,147,483,647
//        int a=1555555574;
//        System.out.println(a);
//4. long	8 bytes	Stores signed whole numbers from -9,223,372,036,854,775,808 to 9,223,372,036,854,775,807
